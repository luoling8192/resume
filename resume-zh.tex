...
小学开始接触编程，高中参加过信息学奥林匹克竞赛，具有深厚的计算机兴趣和探索精神。
拥有超过 5 年的项目开发经验。熟练掌握 Linux 操作及前端和后端开发技能，积极参与开源项目，致力于创新和技术解决方案。
为 \link{https://github.com/Icalingua-plus-plus/Icalingua-plus-plus}{Icalingua++} ， \link{https://github.com/IcariaWorks/ClassTools}{ClassTools+} 等项目贡献过代码。
